<?php
// Script to add all Grade 11 HUMSS students with barcodes
...
$students = [
    // MALE
    ['name' => 'CALUYO, Jymson Anthony L.', 'gender' => 'Male'],
    ['name' => 'FLORENDO, Renald Jay G.', 'gender' => 'Male'],
    ['name' => 'PAMA, Renz Marion G.', 'gender' => 'Male'],
    ['name' => 'SALVADOR, Remart B.', 'gender' => 'Male'],
    // FEMALE
    ['name' => 'BUENO, Ma. Annejelyn D.', 'gender' => 'Female'],
    ['name' => 'CALUNSAG. Hershey Miel P.', 'gender' => 'Female'],
    ['name' => 'CATINA, Rickzel Kaye L.', 'gender' => 'Female'],
    ['name' => 'FERMO, Mary Michaela M.', 'gender' => 'Female'],
    ['name' => 'GUADERA, Precious O.', 'gender' => 'Female'],
    ['name' => 'LAMBUNAO, Mary Loise A.', 'gender' => 'Female'],
    ['name' => 'LATUMBO, Jillian Mae S.', 'gender' => 'Female'],
    ['name' => 'MANZANO. Krisha Mae R.', 'gender' => 'Female'],
    ['name' => 'PAMPOLINA, Cassandrah Dwyne C', 'gender' => 'Female'],
    ['name' => 'PANES. Razel M.', 'gender' => 'Female'],
    ['name' => 'POMANTOC, Crismer Chin S.', 'gender' => 'Female'],
    ['name' => 'SAMON, Jenny Veve O.', 'gender' => 'Female']
];

$course = 'Grade 11 - HUMSS';
$course_year = '11';
...
if (save_data($data)) {
    echo "<!DOCTYPE html>";
    echo "<html><head><title>Grade 11 HUMSS Students Added</title>";
    ...
    echo "<p class='text-lg text-gray-800 mb-2'><strong>Added {$added_count} Grade 11 HUMSS students with barcodes.</strong></p>";
    echo "<p class='text-gray-700'>• 4 Male students</p>";
