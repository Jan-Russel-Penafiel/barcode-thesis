<?php
// Script to add all Grade 12 ICT students with barcodes
...
$students = [
    // MALE
    ['name' => 'GALAY, Nathaniel John B.', 'gender' => 'Male'],
    ['name' => 'GOMEZ, Al Muqeet S.', 'gender' => 'Male'],
    ['name' => 'LEBAQUIN, Loui Jhon Raff O.', 'gender' => 'Male'],
    ['name' => 'LUMATAO, Daniel Jay C.', 'gender' => 'Male'],
    ['name' => 'MAMASALANANG, Datu Lowrence A.', 'gender' => 'Male'],
    ['name' => 'MANALOTO, Ron Victor L.', 'gender' => 'Male'],
    ['name' => 'MARZO, Abdul Rajib S.', 'gender' => 'Male'],
    ['name' => 'NAMOC, Milton James D.', 'gender' => 'Male'],
    ['name' => 'VILLAVER, Gerald M.', 'gender' => 'Male'],
    // FEMALE
    ['name' => 'AGLUBO, Honey Princess A.', 'gender' => 'Female'],
    ['name' => 'ARPOCIA, Jessica F.', 'gender' => 'Female'],
    ['name' => 'LAGARDE, Angel Faith E.', 'gender' => 'Female'],
    ['name' => 'MANTAWIL, Elijean B.', 'gender' => 'Female'],
    ['name' => 'MITMUG, Injiel Fatmah M.', 'gender' => 'Female'],
    ['name' => 'SALES, Shaima\'a S.', 'gender' => 'Female'],
    ['name' => 'SANDOVAL, Leam P.', 'gender' => 'Female'],
    ['name' => 'SENDIANG, Precious C.', 'gender' => 'Female']
];
...
if (save_data($data)) {
    echo "<!DOCTYPE html>";
    echo "<html><head><title>Grade 12 ICT Students Added</title>";
    ...
    echo "<p class='text-lg text-gray-800 mb-2'><strong>Added {$added_count} Grade 12 ICT students with barcodes.</strong></p>";
    echo "<p class='text-gray-700'>• 9 Male students</p>";
    echo "<p class='text-gray-700'>• 8 Female students</p>";
